...
@Log4j2
public class PlaypenClient extends APIClient {
    ...
    @Getter
    private List<PlaypenListener> listeners = new ArrayList<>();

    private boolean awaitingAckResponse = false;

    public PlaypenClient(String name, String uuid, String key, InetAddress ip, int port) {
        super();
